...
struct FRigDefinitionMapping {
	struct TArray<int32_t> InputCurveIndices; // 0x00(0x10)
	struct TArray<int32_t> HierarchyBoneIndices; // 0x10(0x10)
	struct TArray<struct FRigUnit_RigLogic_IntArray> MorphTargetCurveIndices; // 0x20(0x10)
	struct TArray<struct FRigUnit_RigLogic_IntArray> BlendShapeIndices; // 0x30(0x10)
	struct TArray<struct FRigUnit_RigLogic_IntArray> CurveElementIndicesForAnimMaps; // 0x40(0x10)
	struct TArray<struct FRigUnit_RigLogic_IntArray> RigLogicIndicesForAnimMaps; // 0x50(0x10)
};
...
struct FRigUnit_RigLogic : FRigUnitMutable {
	struct FRigUnit_RigLogic_Data Data; // 0xd0(0x30)
};
