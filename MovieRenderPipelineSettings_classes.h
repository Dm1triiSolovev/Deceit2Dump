...
struct UMoviePipelineBurnInWidget : UUserWidget {
	...
	void OnOutputFrameStarted(struct UMoviePipeline* ForPipeline); // Function MovieRenderPipelineSettings.MoviePipelineBurnInWidget.OnOutputFrameStarted // (Event|Public|BlueprintEvent) // @ game+0x2552560
};
