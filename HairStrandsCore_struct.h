...
struct FHairGroupInfo {
	...
	int32_t NumCurves; // 0x0c(0x04)
	int32_t NumGuides; // 0x10(0x04)
	int32_t NumCurveVertices; // 0x14(0x04)
	int32_t NumGuideVertices; // 0x18(0x04)
	float MaxCurveLength; // 0x1c(0x04)
	float MaxImportedWidth; // 0x20(0x04)
};
...
struct FHairGroupCardsTextures {
	...
	struct UTexture2D* MaterialTexture; // 0x28(0x08)
...
struct FHairGroupsCardsSourceDescription {
	...
	struct FHairGroupCardsTextures Textures; // 0x70(0x38)
	int32_t GroupIndex; // 0xa8(0x04)
	int32_t LODIndex; // 0xac(0x04)
	struct FHairGroupCardsInfo CardsInfo; // 0xb0(0x08)
	struct FString ImportedMeshKey; // 0xb8(0x10)
};
...
struct FHairLODSettings {
	...
	enum class EGroomBindingType BindingType; // 0x16(0x01)
	enum class EGroomOverrideType Simulation; // 0x17(0x01)
	enum class EGroomOverrideType GlobalInterpolation; // 0x18(0x01)
...
struct FHairGroupsMeshesSourceDescription {
	...
	struct FHairGroupCardsTextures Textures; // 0x18(0x38)
	int32_t GroupIndex; // 0x50(0x04)
	int32_t LODIndex; // 0x54(0x04)
	struct FString ImportedMeshKey; // 0x58(0x10)
};
...
struct FHairExternalForces {
	struct FVector GravityVector; // 0x00(0x18)
	float AirDrag; // 0x18(0x04)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct FVector AirVelocity; // 0x20(0x18)
};
...
struct FHairGroupsPhysics {
	...
	struct FHairExternalForces ExternalForces; // 0x38(0x38)
	struct FHairMaterialConstraints MaterialConstraints; // 0x70(0x1d8)
	struct FHairStrandsParameters StrandsParameters; // 0x248(0x98)
};

// ScriptStruct HairStrandsCore.HairSimulationSolver
// Size: 0x01 (Inherited: 0x00)
struct FHairSimulationSolver {
	bool bEnableSimulation; // 0x00(0x01)
};
...
struct FHairSimulationConstraints {
	float BendDamping; // 0x00(0x04)
	float BendStiffness; // 0x04(0x04)
	float StretchDamping; // 0x08(0x04)
	float StretchStiffness; // 0x0c(0x04)
	float StaticFriction; // 0x10(0x04)
	float KineticFriction; // 0x14(0x04)
	float StrandsViscosity; // 0x18(0x04)
	float CollisionRadius; // 0x1c(0x04)
};
...
struct FHairSimulationSetup {
	bool bResetSimulation; // 0x00(0x01)
	bool bDebugSimulation; // 0x01(0x01)
	bool bLocalSimulation; // 0x02(0x01)
	char pad_3[0x1]; // 0x03(0x01)
	float LinearVelocityScale; // 0x04(0x04)
	float AngularVelocityScale; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FString LocalBone; // 0x10(0x10)
	float TeleportDistance; // 0x20(0x04)
...
struct FHairSimulationSettings {
	bool bOverrideSettings; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FHairSimulationSetup SimulationSetup; // 0x08(0x28)
	struct FHairSimulationSolver SolverSettings; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
	struct FHairSimulationForces ExternalForces; // 0x38(0x38)
	struct FHairSimulationConstraints MaterialConstraints; // 0x70(0x20)
};
...
struct FHairGroupsRendering {
	...
	struct FHairGeometrySettings GeometrySettings; // 0x10(0x0c)
	struct FHairShadowSettings ShadowSettings; // 0x1c(0x0c)
	struct FHairAdvancedRenderingSettings AdvancedSettings; // 0x28(0x02)
...
struct FGroomCacheImportSettings {
	...
	char pad_1[0x3]; // 0x01(0x03)
	int32_t FrameStart; // 0x04(0x04)
	int32_t FrameEnd; // 0x08(0x04)
	bool bSkipEmptyFrames; // 0x0c(0x01)
	bool bImportGroomAsset; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
	struct FSoftObjectPath GroomAsset; // 0x10(0x18)
};
...
struct FHairGroupDesc {
	...
	char pad_19[0x3]; // 0x19(0x03)
	float HairShadowDensity; // 0x1c(0x04)
	bool HairShadowDensity_Override; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	float HairRaytracingRadiusScale; // 0x24(0x04)
	bool HairRaytracingRadiusScale_Override; // 0x28(0x01)
	bool bUseHairRaytracingGeometry; // 0x29(0x01)
	bool bUseHairRaytracingGeometry_Override; // 0x2a(0x01)
	char pad_2B[0x1]; // 0x2b(0x01)
	float LODBias; // 0x2c(0x04)
	bool bUseStableRasterization; // 0x30(0x01)
	bool bUseStableRasterization_Override; // 0x31(0x01)
	bool bScatterSceneLighting; // 0x32(0x01)
	bool bScatterSceneLighting_Override; // 0x33(0x01)
	bool bSupportVoxelization; // 0x34(0x01)
	bool bSupportVoxelization_Override; // 0x35(0x01)
	char pad_36[0x2]; // 0x36(0x02)
	float HairLengthScale; // 0x38(0x04)
	bool HairLengthScale_Override; // 0x3c(0x01)
...
struct FGroomHairGroupPreview {
	...
	int32_t CurveCount; // 0x0c(0x04)
	int32_t GuideCount; // 0x10(0x04)
	bool bHasPrecomputedWeights; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FHairGroupsInterpolation InterpolationSettings; // 0x18(0x14)
};

// ScriptStruct HairStrandsCore.GroomConversionSettings
// Size: 0x30 (Inherited: 0x00)
struct FGroomConversionSettings {
	struct FVector Rotation; // 0x00(0x18)
	struct FVector Scale; // 0x18(0x18)
};
