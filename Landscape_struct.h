...
struct FGrassInput {
	...
	struct FExpressionInput Input; // 0x10(0x14)
...
struct FLayerBlendInput {
	...
	struct FExpressionInput LayerInput; // 0x0c(0x14)
	struct FExpressionInput HeightInput; // 0x20(0x14)
	float PreviewWeight; // 0x34(0x04)
	struct FVector ConstLayerInput; // 0x38(0x18)
	float ConstHeightInput; // 0x50(0x04)
