// AnimBlueprintGeneratedClass m_med_unw_top_hoodie_AnimBP.m_med_unw_top_hoodie_AnimBP_C
// Size: 0x1d18 (Inherited: 0x350)
struct Um_med_unw_top_hoodie_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function m_med_unw_top_hoodie_AnimBP.m_med_unw_top_hoodie_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2552560
	void ExecuteUbergraph_m_med_unw_top_hoodie_AnimBP(int32_t EntryPoint); // Function m_med_unw_top_hoodie_AnimBP.m_med_unw_top_hoodie_AnimBP_C.ExecuteUbergraph_m_med_unw_top_hoodie_AnimBP // (Final|UbergraphFunction) // @ game+0x2552560
};
