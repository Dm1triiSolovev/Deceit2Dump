...
struct FActorPerceptionUpdateInfo {
	...
	struct FAIStimulus Stimulus; // 0x10(0x58)
};
...
struct FAIStimulus {
	...
	char pad_54_0 : 1; // 0x54(0x01)
	char bSuccessfullySensed : 1; // 0x54(0x01)
...
struct FAIDataProviderTypedValue : FAIDataProviderValue {
	ClassPtrProperty PropertyType; // 0x20(0x08)
...
struct FEnvTraceData {
	...
	struct FName TraceProfileName; // 0x2c(0x08)
	enum class EEnvTraceShape TraceShape; // 0x34(0x01)
	enum class EEnvQueryTrace TraceMode; // 0x35(0x01)
	char pad_36[0x2]; // 0x36(0x02)
	char bTraceComplex : 1; // 0x38(0x01)
	char bOnlyBlockingHits : 1; // 0x38(0x01)
	char bCanTraceOnNavMesh : 1; // 0x38(0x01)
	char bCanTraceOnGeometry : 1; // 0x38(0x01)
	char bCanDisableTrace : 1; // 0x38(0x01)
	char bCanProjectDown : 1; // 0x38(0x01)
