...
struct FPlayerMappableKeyOptions {
	...
	struct FText DisplayCategory; // 0x20(0x18)
};
...
struct FEnhancedActionKeyMapping {
	...
	struct FPlayerMappableKeyOptions PlayerMappableOptions; // 0x28(0x38)
	char bShouldBeIgnored : 1; // 0x60(0x01)
	char pad_60_1 : 7; // 0x60(0x01)
	char pad_61[0x7]; // 0x61(0x07)
	struct TArray<struct UInputTrigger*> Triggers; // 0x68(0x10)
	struct TArray<struct UInputModifier*> Modifiers; // 0x78(0x10)
};
