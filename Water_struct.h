...
struct FSphericalPontoon {
	...
	char pad_10C[0x1ac]; // 0x10c(0x1ac)
...
struct FBuoyancyData {
	...
	bool bApplyDragForcesInWater; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	float DragCoefficient; // 0x30(0x04)
	float DragCoefficient2; // 0x34(0x04)
	float AngularDragCoefficient; // 0x38(0x04)
	float MaxDragSpeed; // 0x3c(0x04)
	bool bApplyRiverForces; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	int32_t RiverPontoonIndex; // 0x44(0x04)
	float WaterShorePushFactor; // 0x48(0x04)
	float RiverTraversalPathWidth; // 0x4c(0x04)
	float MaxShorePushForce; // 0x50(0x04)
	float WaterVelocityStrength; // 0x54(0x04)
	float MaxWaterForce; // 0x58(0x04)
	bool bAlwaysAllowLateralPush; // 0x5c(0x01)
	bool bAllowCurrentWhenMovingFastUpstream; // 0x5d(0x01)
	bool bApplyDownstreamAngularRotation; // 0x5e(0x01)
	char pad_5F[0x1]; // 0x5f(0x01)
	struct FVector DownstreamAxisOfRotation; // 0x60(0x18)
	float DownstreamRotationStrength; // 0x78(0x04)
	float DownstreamRotationStiffness; // 0x7c(0x04)
	float DownstreamRotationAngularDamping; // 0x80(0x04)
	float DownstreamMaxAcceleration; // 0x84(0x04)
};
...
struct FUnderwaterPostProcessSettings {
	...
	struct FPostProcessSettings PostProcessSettings; // 0x10(0x6c0)
	struct UMaterialInterface* UnderwaterPostProcessMaterial; // 0x6d0(0x08)
