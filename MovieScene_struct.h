...
struct FMovieSceneFloatChannel : FMovieSceneChannel {
	...
	struct FMovieSceneKeyHandleMap KeyHandles; // 0x80(0x60)
	struct FFrameRate TickResolution; // 0xe0(0x08)
};
...
struct FMovieSceneBindingOverrideData {
	...
	struct TSoftObjectPtr<UObject> Object; // 0x18(0x28)
	bool bOverridesDefault; // 0x40(0x01)
...
struct FMovieSceneDoubleChannel : FMovieSceneChannel {
	...
	struct FMovieSceneKeyHandleMap KeyHandles; // 0x88(0x60)
	struct FFrameRate TickResolution; // 0xe8(0x08)
};
...
struct FMovieSceneEvaluationFieldEntityMetaData {
	...
	char bEvaluateInSequencePreRoll : 1; // 0x19(0x01)
	char bEvaluateInSequencePostRoll : 1; // 0x19(0x01)
...
struct FMovieSceneRootEvaluationTemplateInstance {
	...
	struct TMap<struct FMovieSceneSequenceID, struct UObject*> DirectorInstances; // 0x88(0x50)
...
struct FMovieScenePossessable {
	...
	struct FGuid ParentGuid; // 0x30(0x10)
	struct FMovieSceneObjectBindingID SpawnableObjectBindingID; // 0x40(0x18)
};
...
struct FMovieSceneSubSequenceData {
	...
	struct FFrameRate TickResolution; // 0x58(0x08)
	struct FMovieSceneSequenceID DeterministicSequenceID; // 0x60(0x04)
	struct FMovieSceneFrameRange ParentPlayRange; // 0x64(0x10)
	struct FFrameNumber ParentStartFrameOffset; // 0x74(0x04)
	struct FFrameNumber ParentEndFrameOffset; // 0x78(0x04)
	struct FFrameNumber ParentFirstLoopStartFrameOffset; // 0x7c(0x04)
	bool bCanLoop; // 0x80(0x01)
	...
	int16_t HierarchicalBias; // 0xd4(0x02)
	bool bHasHierarchicalEasing; // 0xd6(0x01)
...
struct FMovieSceneSequenceActorPointers {
	struct AActor* SequenceActor; // 0x00(0x08)
	struct TScriptInterface<IMovieSceneSequenceActor> SequenceActorInterface; // 0x08(0x10)
};
...
struct FMovieSceneSpawnable {
	...
	bool bEvaluateTracksWhenNotSpawned; // 0x72(0x01)
	char pad_73[0x1]; // 0x73(0x01)
	struct FGuid Guid; // 0x74(0x10)
	char pad_84[0x4]; // 0x84(0x04)
	struct FString Name; // 0x88(0x10)
	struct UObject* ObjectTemplate; // 0x98(0x08)
	struct TArray<struct FGuid> ChildPossessables; // 0xa0(0x10)
	enum class ESpawnOwnership Ownership; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	struct FName LevelName; // 0xb4(0x08)
