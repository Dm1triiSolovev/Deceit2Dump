...
struct FMovieSceneActorReferenceData : FMovieSceneChannel {
	...
	struct FMovieSceneActorReferenceKey DefaultValue; // 0x60(0x28)
	struct TArray<struct FMovieSceneActorReferenceKey> KeyValues; // 0x88(0x10)
...
struct FMovieSceneActorReferenceSectionTemplate : FMovieSceneEvalTemplate {
	...
	struct FMovieSceneActorReferenceData ActorReferenceData; // 0x38(0xf8)
};
...
struct FMovieScenePrimitiveMaterialTemplate : FMovieSceneEvalTemplate {
	...
	struct FMovieSceneObjectPathChannel MaterialChannel; // 0x28(0x108)
};
...
struct FMovieSceneSkeletalAnimationParams {
	...
	struct FMovieSceneFloatChannel Weight; // 0x30(0xe8)
	bool bSkipAnimNotifiers; // 0x118(0x01)
	bool bForceCustomMode; // 0x119(0x01)
	char pad_11A[0x2]; // 0x11a(0x02)
	float StartOffset; // 0x11c(0x04)
	float EndOffset; // 0x120(0x04)
...
struct FMovieSceneSkeletalAnimationSectionTemplateParameters : FMovieSceneSkeletalAnimationParams {
	struct FFrameNumber SectionStartTime; // 0x128(0x04)
	struct FFrameNumber SectionEndTime; // 0x12c(0x04)
};

// ScriptStruct MovieSceneTracks.MovieSceneSkeletalAnimationSectionTemplate
// Size: 0x150 (Inherited: 0x20)
struct FMovieSceneSkeletalAnimationSectionTemplate : FMovieSceneEvalTemplate {
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params; // 0x20(0x130)
};
