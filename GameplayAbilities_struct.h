...
struct FGameplayCueParameters {
	...
	struct FVector_NetQuantize10 Location; // 0x70(0x18)
	struct FVector_NetQuantizeNormal Normal; // 0x88(0x18)
	struct TWeakObjectPtr<struct AActor> Instigator; // 0xa0(0x08)
	struct TWeakObjectPtr<struct AActor> EffectCauser; // 0xa8(0x08)
	struct TWeakObjectPtr<struct UObject> SourceObject; // 0xb0(0x08)
	struct TWeakObjectPtr<struct UPhysicalMaterial> PhysicalMaterial; // 0xb8(0x08)
	int32_t GameplayEffectLevel; // 0xc0(0x04)
	int32_t AbilityLevel; // 0xc4(0x04)
	struct TWeakObjectPtr<struct USceneComponent> TargetAttachComponent; // 0xc8(0x08)
	bool bReplicateLocationWhenUsingMinimalRepProxy; // 0xd0(0x01)
...
struct FActiveGameplayCue : FFastArraySerializerItem {
	...
	struct FGameplayCueParameters Parameters; // 0x30(0xd8)
	bool bPredictivelyRemoved; // 0x108(0x01)
...
struct FGameplayAbilityTargetingLocationInfo {
	...
	struct FName SourceSocketName; // 0x98(0x08)
};
...
struct FMinimalGameplayCueReplicationProxy {
	char pad_0[0x340]; // 0x00(0x340)
	struct UAbilitySystemComponent* Owner; // 0x340(0x08)
...
struct FGameplayCueNotify_PlacementInfo {
	...
	enum class EGameplayCueNotify_AttachPolicy AttachPolicy; // 0x08(0x01)
	enum class EAttachmentRule AttachmentRule; // 0x09(0x01)
	char pad_A[0x2]; // 0x0a(0x02)
	char bOverrideRotation : 1; // 0x0c(0x01)
	char bOverrideScale : 1; // 0x0c(0x01)
...
struct FGameplayCueNotify_SpawnResult {
	...
	struct UCameraAnimInst* CameraAnim; // 0x30(0x08)
	struct TArray<struct TScriptInterface<ICameraLensEffectInterface>> CameraLensEffects; // 0x38(0x10)
	struct UForceFeedbackComponent* ForceFeedbackComponent; // 0x48(0x08)
	struct APlayerController* ForceFeedbackTargetPC; // 0x50(0x08)
	struct UDecalComponent* DecalComponent; // 0x58(0x08)
};
...
struct FGameplayCueNotify_SoundParameterInterfaceInfo {
	struct FName StopTriggerName; // 0x00(0x08)
};
...
struct FGameplayCueNotify_SoundInfo {
	...
	struct FGameplayCueNotify_SoundParameterInterfaceInfo SoundParameterInterfaceInfo; // 0x90(0x08)
	char bOverrideSpawnCondition : 1; // 0x98(0x01)
	char bOverridePlacementInfo : 1; // 0x98(0x01)
	char bUseSoundParameterInterface : 1; // 0x98(0x01)
...
struct FGameplayCueNotify_CameraAnimInfo {
	struct FGameplayCueNotify_SpawnCondition SpawnConditionOverride; // 0x00(0x38)
	struct UCameraAnim* CameraAnim; // 0x38(0x08)
	float AnimScale; // 0x40(0x04)
	float PlayRate; // 0x44(0x04)
	float BlendInTime; // 0x48(0x04)
	float BlendOutTime; // 0x4c(0x04)
	enum class EGameplayCueNotify_EffectPlaySpace PlaySpace; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	char bIsLooping : 1; // 0x54(0x01)
	char bRandomStartTime : 1; // 0x54(0x01)
	char bOverrideSpawnCondition : 1; // 0x54(0x01)
...
struct FGameplayCueNotify_ForceFeedbackInfo {
	...
	struct FName ForceFeedbackTag; // 0x80(0x08)
	char bIsLooping : 1; // 0x88(0x01)
	char bOverrideSpawnCondition : 1; // 0x88(0x01)
	char bOverridePlacementInfo : 1; // 0x88(0x01)
	char bPlayInWorld : 1; // 0x88(0x01)
	char pad_88_4 : 4; // 0x88(0x01)
	char pad_89[0x3]; // 0x89(0x03)
	float WorldIntensity; // 0x8c(0x04)
...
struct FGameplayCueNotify_BurstEffects {
	...
	struct FGameplayCueNotify_CameraAnimInfo BurstCameraAnim; // 0xb8(0x58)
	struct FGameplayCueNotify_CameraLensEffectInfo BurstCameraLensEffect; // 0x110(0x90)
	struct FGameplayCueNotify_ForceFeedbackInfo BurstForceFeedback; // 0x1a0(0x98)
	struct FGameplayCueNotify_DecalInfo BurstDecal; // 0x238(0xa8)
};
...
struct FGameplayCueNotify_LoopingEffects {
	...
	struct FGameplayCueNotify_CameraAnimInfo LoopingCameraAnim; // 0xb8(0x58)
	struct FGameplayCueNotify_CameraLensEffectInfo LoopingCameraLensEffect; // 0x110(0x90)
	struct FGameplayCueNotify_ForceFeedbackInfo LoopingForceFeedback; // 0x1a0(0x98)
};
...
struct FGameplayCuePendingExecute {
	...
	struct FGameplayCueParameters CueParameters; // 0xb8(0xd8)
};
...
struct FGameplayEffectModifierMagnitude {
	...
	struct FSetByCallerFloat SetByCallerMagnitude; // 0x1d0(0x10)
};
...
struct FGameplayEffectExecutionScopedModifierInfo {
	...
	struct FGameplayEffectModifierMagnitude ModifierMagnitude; // 0x50(0x1e0)
	struct FGameplayModEvaluationChannelSettings EvaluationChannelSettings; // 0x230(0x01)
	char pad_231[0x7]; // 0x231(0x07)
	struct FGameplayTagRequirements SourceTags; // 0x238(0x40)
	struct FGameplayTagRequirements TargetTags; // 0x278(0x40)
};
...
struct FGameplayModifierInfo {
	...
	struct FGameplayEffectModifierMagnitude ModifierMagnitude; // 0x68(0x1e0)
	struct FGameplayModEvaluationChannelSettings EvaluationChannelSettings; // 0x248(0x01)
	char pad_249[0x7]; // 0x249(0x07)
	struct FGameplayTagRequirements SourceTags; // 0x250(0x40)
	struct FGameplayTagRequirements TargetTags; // 0x290(0x40)
};
...
struct FMovieSceneGameplayCueKey {
	struct FGameplayCueTag Cue; // 0x00(0x08)
	struct FVector Location; // 0x08(0x18)
	struct FVector Normal; // 0x20(0x18)
	struct FName AttachSocketName; // 0x38(0x08)
	float NormalizedMagnitude; // 0x40(0x04)
	struct FMovieSceneObjectBindingID Instigator; // 0x44(0x18)
	struct FMovieSceneObjectBindingID EffectCauser; // 0x5c(0x18)
	char pad_74[0x4]; // 0x74(0x04)
	struct UPhysicalMaterial* PhysicalMaterial; // 0x78(0x08)
	int32_t GameplayEffectLevel; // 0x80(0x04)
	int32_t AbilityLevel; // 0x84(0x04)
	bool bAttachToBinding; // 0x88(0x01)
