...
struct FAnimNode_AimOffsetLookAt : FAnimNode_BlendSpacePlayer {
	...
	struct FName SourceSocketName; // 0x144(0x08)
	struct FName PivotSocketName; // 0x14c(0x08)
...
struct FAnimNode_AnimDynamics : FAnimNode_SkeletalControlBase {
	...
	float SphereCollisionRadius; // 0x310(0x04)
	char pad_314[0x4]; // 0x314(0x04)
	struct FVector ExternalForce; // 0x318(0x18)
	struct TArray<struct FAnimPhysPlanarLimit> PlanarLimits; // 0x330(0x10)
	enum class AnimPhysCollisionType CollisionType; // 0x340(0x01)
	enum class AnimPhysSimSpaceType SimulationSpace; // 0x341(0x01)
	char pad_342[0x2]; // 0x342(0x02)
	char bUseSphericalLimits : 1; // 0x344(0x01)
	char bUsePlanarLimit : 1; // 0x344(0x01)
	char bDoUpdate : 1; // 0x344(0x01)
	char bDoEval : 1; // 0x344(0x01)
	char bOverrideLinearDamping : 1; // 0x344(0x01)
	char bOverrideAngularBias : 1; // 0x344(0x01)
	char bOverrideAngularDamping : 1; // 0x344(0x01)
	char bEnableWind : 1; // 0x344(0x01)
	char pad_345_0 : 1; // 0x345(0x01)
	char bUseGravityOverride : 1; // 0x345(0x01)
	char bGravityOverrideInSimSpace : 1; // 0x345(0x01)
	char bLinearSpring : 1; // 0x345(0x01)
	char bAngularSpring : 1; // 0x345(0x01)
	char bChain : 1; // 0x345(0x01)
	char pad_345_6 : 2; // 0x345(0x01)
...
struct FAnimNode_BlendSpaceGraphBase : FAnimNode_Base {
	float X; // 0x10(0x04)
	float Y; // 0x14(0x04)
	struct FName GroupName; // 0x18(0x08)
	enum class EAnimGroupRole GroupRole; // 0x20(0x01)
...
struct FAnimNode_CCDIK : FAnimNode_SkeletalControlBase {
	...
	int32_t MaxIterations; // 0x1a4(0x04)
...
struct FAnimNode_Fabrik : FAnimNode_SkeletalControlBase {
	...
	int32_t MaxIterations; // 0x1e4(0x04)
	enum class EBoneControlSpace EffectorTransformSpace; // 0x1e8(0x01)
	enum class EBoneRotationSource EffectorRotationSource; // 0x1e9(0x01)
...
struct FAnimNode_LookAt : FAnimNode_SkeletalControlBase {
	...
	bool bUseLookUpAxis; // 0x1a8(0x01)
	enum class EInterpolationBlend InterpolationType; // 0x1a9(0x01)
	char pad_1AA[0x6]; // 0x1aa(0x06)
	struct FAxis LookUp_Axis; // 0x1b0(0x20)
	float LookAtClamp; // 0x1d0(0x04)
	float InterpolationTime; // 0x1d4(0x04)
	float InterpolationTriggerThreashold; // 0x1d8(0x04)
	char pad_1DC[0x74]; // 0x1dc(0x74)
};
...
struct FAnimNode_PoseByName : FAnimNode_PoseHandler {
	struct FName PoseName; // 0x90(0x08)
	float PoseWeight; // 0x98(0x04)
...
struct FAnimNode_PoseDriver : FAnimNode_PoseHandler {
	...
	bool bEvalFromRefPose; // 0x110(0x01)
	char pad_111[0x7]; // 0x111(0x07)
	...
	int32_t LODThreshold; // 0x154(0x04)
...
struct FAnimNode_RigidBody : FAnimNode_SkeletalControlBase {
	...
	enum class ECollisionChannel OverlapChannel; // 0x2ec(0x01)
	enum class ESimulationSpace SimulationSpace; // 0x2ed(0x01)
	bool bForceDisableCollisionBetweenConstraintBodies; // 0x2ee(0x01)
	char pad_2EF[0x1]; // 0x2ef(0x01)
	char bEnableWorldGeometry : 1; // 0x2f0(0x01)
	char bOverrideWorldGravity : 1; // 0x2f0(0x01)
	char bTransferBoneVelocities : 1; // 0x2f0(0x01)
	char bFreezeIncomingPoseOnStart : 1; // 0x2f0(0x01)
	char bClampLinearTranslationLimitToRefPose : 1; // 0x2f0(0x01)
	char pad_2F0_5 : 3; // 0x2f0(0x01)
	char pad_2F1[0x3]; // 0x2f1(0x03)
	float WorldSpaceMinimumScale; // 0x2f4(0x04)
	float EvaluationResetTime; // 0x2f8(0x04)
	char pad_2FC[0x694]; // 0x2fc(0x694)
};
...
struct FAnimNode_RotationOffsetBlendSpace : FAnimNode_BlendSpacePlayer {
	...
	enum class EAnimAlphaInputType AlphaInputType; // 0x10c(0x01)
	bool bAlphaBoolEnabled; // 0x10d(0x01)
...
struct FAnimNode_ScaleChainLength : FAnimNode_Base {
	...
	enum class EScaleChainInitialLength ChainInitialLength; // 0x70(0x01)
...
struct FAnimNode_Sync : FAnimNode_Base {
	struct FPoseLink Source; // 0x10(0x10)
	struct FName GroupName; // 0x20(0x08)
	enum class EAnimGroupRole GroupRole; // 0x28(0x01)
...
struct FAnimNode_Trail : FAnimNode_SkeletalControlBase {
	...
	float LastBoneRotationAnimAlphaBlend; // 0x268(0x04)
	char pad_26C[0x34]; // 0x26c(0x34)
};
...
struct FAnimNode_TwoBoneIK : FAnimNode_SkeletalControlBase {
	...
	enum class EBoneControlSpace EffectorLocationSpace; // 0x260(0x01)
	enum class EBoneControlSpace JointTargetLocationSpace; // 0x261(0x01)
	char bAllowStretching : 1; // 0x262(0x01)
	char bTakeRotationFromEffectorSpace : 1; // 0x262(0x01)
	char bMaintainEffectorRelRot : 1; // 0x262(0x01)
	char bAllowTwist : 1; // 0x262(0x01)
	char pad_262_4 : 4; // 0x262(0x01)
	char pad_263[0xd]; // 0x263(0x0d)
};
