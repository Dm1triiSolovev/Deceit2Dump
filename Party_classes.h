...
struct USocialParty : UObject {
	...
	char pad_198[0x78]; // 0x198(0x78)
	struct APartyBeaconClient* ReservationBeaconClient; // 0x210(0x08)
	char pad_218[0x8]; // 0x218(0x08)
	struct ASpectatorBeaconClient* SpectatorBeaconClient; // 0x220(0x08)
...
struct USocialToolkit : UObject {
	...
	struct ULocalPlayer* LocalPlayerOwner; // 0xd0(0x08)
