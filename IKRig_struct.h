...
struct FAnimNode_IKRig : FAnimNode_CustomProperty {
	...
	struct FName AlphaCurveName; // 0xd8(0x08)
...
struct FIKRigGoal {
	...
	enum class EIKRigGoalTransformSource TransformSource; // 0x08(0x01)
	char pad_9[0x3]; // 0x09(0x03)
	struct FBoneReference SourceBone; // 0x0c(0x10)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct FVector position; // 0x20(0x18)
	struct FRotator Rotation; // 0x38(0x18)
	float PositionAlpha; // 0x50(0x04)
	float RotationAlpha; // 0x54(0x04)
	enum class EIKRigGoalSpace PositionSpace; // 0x58(0x01)
	enum class EIKRigGoalSpace RotationSpace; // 0x59(0x01)
...
struct FAnimNode_RetargetPoseFromMesh : FAnimNode_Base {
	...
	struct UIKRetargetProcessor* Processor; // 0x38(0x08)
...
struct FRetargetChainMap {
	struct FName SourceChain; // 0x00(0x08)
	struct FName TargetChain; // 0x08(0x08)
};
...
struct FBoneChain {
	struct FName ChainName; // 0x00(0x08)
	struct FBoneReference StartBone; // 0x08(0x10)
	struct FBoneReference EndBone; // 0x18(0x10)
	struct FName IKGoalName; // 0x28(0x08)
};

// ScriptStruct IKRig.RetargetDefinition
// Size: 0x18 (Inherited: 0x00)
struct FRetargetDefinition {
	struct FName RootBone; // 0x00(0x08)
