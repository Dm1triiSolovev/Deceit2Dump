...
struct ADatasmithAreaLightActor : AActor {
	enum class EComponentMobility Mobility; // 0x278(0x01)
	enum class EDatasmithAreaLightActorType LightType; // 0x279(0x01)
	enum class EDatasmithAreaLightActorShape LightShape; // 0x27a(0x01)
	char pad_27B[0x5]; // 0x27b(0x05)
	struct FVector2D Dimensions; // 0x280(0x10)
	float Intensity; // 0x290(0x04)
	enum class ELightUnits IntensityUnits; // 0x294(0x01)
	char pad_295[0x3]; // 0x295(0x03)
	struct FLinearColor Color; // 0x298(0x10)
	float Temperature; // 0x2a8(0x04)
	...
	struct FRotator Rotation; // 0x2c0(0x18)
	float SourceRadius; // 0x2d8(0x04)
	float SourceLength; // 0x2dc(0x04)
	float AttenuationRadius; // 0x2e0(0x04)
	float SpotlightInnerAngle; // 0x2e4(0x04)
	float SpotlightOuterAngle; // 0x2e8(0x04)
...
struct UDatasmithAreaLightActorTemplate : UDatasmithObjectTemplate {
	...
	struct FVector2D Dimensions; // 0x38(0x10)
	struct FLinearColor Color; // 0x48(0x10)
	float Intensity; // 0x58(0x04)
	enum class ELightUnits IntensityUnits; // 0x5c(0x01)
	char pad_5D[0x3]; // 0x5d(0x03)
	float Temperature; // 0x60(0x04)
	char pad_64[0x4]; // 0x64(0x04)
	struct TSoftObjectPtr<UTextureLightProfile> IESTexture; // 0x68(0x28)
...
struct UDatasmithContentBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FString GetDatasmithUserDataValueForKey(struct UObject* Object, struct FName Key); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x2065130
	void GetDatasmithUserDataKeysAndValuesForValue(struct UObject* Object, struct FString StringToMatch, struct TArray<struct FName>& OutKeys, struct TArray<struct FString>& OutValues); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x2064f70
	struct UDatasmithAssetUserData* GetDatasmithUserData(struct UObject* Object); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x2064ee0
};
...
struct UDatasmithDecalComponentTemplate : UDatasmithObjectTemplate {
	...
	struct FVector DecalSize; // 0x38(0x18)
...
struct ADatasmithImportedSequencesActor : AActor {
	struct TArray<struct ULevelSequence*> ImportedSequences; // 0x278(0x10)

	void PlayLevelSequence(struct ULevelSequence* SequenceToPlay); // Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence // (Final|Native|Public|BlueprintCallable) // @ game+0x2065240
};
...
struct UDatasmithImportOptions : UDatasmithOptionsBase {
	...
	struct FString SourceUri; // 0x68(0x10)
...
struct ADatasmithSceneActor : AActor {
	struct UDatasmithScene* Scene; // 0x278(0x08)
	struct TMap<struct FName, struct TSoftObjectPtr<AActor>> RelatedActors; // 0x280(0x50)
};
...
struct UDatasmithSceneComponentTemplate : UDatasmithObjectTemplate {
	...
	enum class EComponentMobility Mobility; // 0x90(0x01)
	char pad_91[0x7]; // 0x91(0x07)
	struct TSoftObjectPtr<USceneComponent> AttachParent; // 0x98(0x28)
	bool bVisible; // 0xc0(0x01)
	char pad_C1[0x7]; // 0xc1(0x07)
	struct TSet<struct FName> Tags; // 0xc8(0x50)
