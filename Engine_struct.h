...
struct FMaterialInput {
	...
	struct FName ExpressionName; // 0x0c(0x08)
};
...
struct FMaterialAttributesInput : FExpressionInput {
	int32_t PropertyConnectedBitmask; // 0x14(0x04)
};
...
struct FHitResult {
	...
	struct FName BoneName; // 0xd8(0x08)
	struct FName MyBoneName; // 0xe0(0x08)
};
...
struct FBodyInstance : FBodyInstanceCore {
	...
	struct FName CollisionProfileName; // 0x78(0x08)
	char PositionSolverIterationCount; // 0x80(0x01)
	char VelocitySolverIterationCount; // 0x81(0x01)
...
struct FPostProcessSettings {
	...
	char bOverride_LocalExposureBlurredLuminanceKernelSizePercent : 1; // 0x0a(0x01)
	char bOverride_LocalExposureMiddleGreyBias : 1; // 0x0a(0x01)
	...
	char bOverride_VignetteIntensity : 1; // 0x0b(0x01)
	char bOverride_GrainIntensity : 1; // 0x0b(0x01)
	...
	char bOverride_FilmGrainHighlightsMin : 1; // 0x0c(0x01)
	char bOverride_FilmGrainHighlightsMax : 1; // 0x0c(0x01)
	...
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x408(0x01)
	char pad_409[0x3]; // 0x409(0x03)
	int32_t RayTracingGIMaxBounces; // 0x40c(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x410(0x04)
	enum class EReflectionMethod ReflectionMethod; // 0x414(0x01)
	enum class EReflectionsType ReflectionsType; // 0x415(0x01)
	char pad_416[0x2]; // 0x416(0x02)
	float LumenReflectionQuality; // 0x418(0x04)
	enum class ELumenRayLightingModeOverride LumenRayLightingMode; // 0x41c(0x01)
	char pad_41D[0x3]; // 0x41d(0x03)
	float ScreenSpaceReflectionIntensity; // 0x420(0x04)
	float ScreenSpaceReflectionQuality; // 0x424(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x428(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x42c(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x430(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x434(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x438(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x439(0x01)
	char pad_439_1 : 7; // 0x439(0x01)
	char pad_43A[0x2]; // 0x43a(0x02)
	struct FLinearColor AmbientCubemapTint; // 0x43c(0x10)
	float AmbientCubemapIntensity; // 0x44c(0x04)
	struct UTextureCube* AmbientCubemap; // 0x450(0x08)
	float CameraShutterSpeed; // 0x458(0x04)
	float CameraISO; // 0x45c(0x04)
	float DepthOfFieldFstop; // 0x460(0x04)
	float DepthOfFieldMinFstop; // 0x464(0x04)
	int32_t DepthOfFieldBladeCount; // 0x468(0x04)
	float AutoExposureBias; // 0x46c(0x04)
	float AutoExposureBiasBackup; // 0x470(0x04)
	char bOverride_AutoExposureBiasBackup : 1; // 0x474(0x01)
	char pad_474_1 : 7; // 0x474(0x01)
	char pad_475[0x3]; // 0x475(0x03)
	char AutoExposureApplyPhysicalCameraExposure : 1; // 0x478(0x01)
	char pad_478_1 : 7; // 0x478(0x01)
	char pad_479[0x7]; // 0x479(0x07)
	struct UCurveFloat* AutoExposureBiasCurve; // 0x480(0x08)
	struct UTexture* AutoExposureMeterMask; // 0x488(0x08)
	float AutoExposureLowPercent; // 0x490(0x04)
	float AutoExposureHighPercent; // 0x494(0x04)
	float AutoExposureMinBrightness; // 0x498(0x04)
	float AutoExposureMaxBrightness; // 0x49c(0x04)
	float AutoExposureSpeedUp; // 0x4a0(0x04)
	float AutoExposureSpeedDown; // 0x4a4(0x04)
	float HistogramLogMin; // 0x4a8(0x04)
	float HistogramLogMax; // 0x4ac(0x04)
	float AutoExposureCalibrationConstant; // 0x4b0(0x04)
	float LocalExposureContrastScale; // 0x4b4(0x04)
	float LocalExposureDetailStrength; // 0x4b8(0x04)
	float LocalExposureBlurredLuminanceBlend; // 0x4bc(0x04)
	float LocalExposureBlurredLuminanceKernelSizePercent; // 0x4c0(0x04)
	float LocalExposureMiddleGreyBias; // 0x4c4(0x04)
	float LensFlareIntensity; // 0x4c8(0x04)
	struct FLinearColor LensFlareTint; // 0x4cc(0x10)
	float LensFlareBokehSize; // 0x4dc(0x04)
	float LensFlareThreshold; // 0x4e0(0x04)
	char pad_4E4[0x4]; // 0x4e4(0x04)
	struct UTexture* LensFlareBokehShape; // 0x4e8(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x4f0(0x80)
	float VignetteIntensity; // 0x570(0x04)
	float GrainJitter; // 0x574(0x04)
	float GrainIntensity; // 0x578(0x04)
	float FilmGrainIntensity; // 0x57c(0x04)
	float FilmGrainIntensityShadows; // 0x580(0x04)
	float FilmGrainIntensityMidtones; // 0x584(0x04)
	float FilmGrainIntensityHighlights; // 0x588(0x04)
	float FilmGrainShadowsMax; // 0x58c(0x04)
	float FilmGrainHighlightsMin; // 0x590(0x04)
	float FilmGrainHighlightsMax; // 0x594(0x04)
	float FilmGrainTexelSize; // 0x598(0x04)
	char pad_59C[0x4]; // 0x59c(0x04)
	struct UTexture2D* FilmGrainTexture; // 0x5a0(0x08)
	float AmbientOcclusionIntensity; // 0x5a8(0x04)
	float AmbientOcclusionStaticFraction; // 0x5ac(0x04)
	float AmbientOcclusionRadius; // 0x5b0(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x5b4(0x01)
	char pad_5B4_1 : 7; // 0x5b4(0x01)
	char pad_5B5[0x3]; // 0x5b5(0x03)
	float AmbientOcclusionFadeDistance; // 0x5b8(0x04)
	float AmbientOcclusionFadeRadius; // 0x5bc(0x04)
	float AmbientOcclusionDistance; // 0x5c0(0x04)
	float AmbientOcclusionPower; // 0x5c4(0x04)
	float AmbientOcclusionBias; // 0x5c8(0x04)
	float AmbientOcclusionQuality; // 0x5cc(0x04)
	float AmbientOcclusionMipBlend; // 0x5d0(0x04)
	float AmbientOcclusionMipScale; // 0x5d4(0x04)
	float AmbientOcclusionMipThreshold; // 0x5d8(0x04)
	float AmbientOcclusionTemporalBlendWeight; // 0x5dc(0x04)
	char RayTracingAO : 1; // 0x5e0(0x01)
	char pad_5E0_1 : 7; // 0x5e0(0x01)
	char pad_5E1[0x3]; // 0x5e1(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x5e4(0x04)
	float RayTracingAOIntensity; // 0x5e8(0x04)
	float RayTracingAORadius; // 0x5ec(0x04)
	float ColorGradingIntensity; // 0x5f0(0x04)
	char pad_5F4[0x4]; // 0x5f4(0x04)
	struct UTexture* ColorGradingLUT; // 0x5f8(0x08)
	float DepthOfFieldSensorWidth; // 0x600(0x04)
	float DepthOfFieldFocalDistance; // 0x604(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x608(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x60c(0x04)
	float DepthOfFieldFocalRegion; // 0x610(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x614(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x618(0x04)
	float DepthOfFieldScale; // 0x61c(0x04)
	float DepthOfFieldNearBlurSize; // 0x620(0x04)
	float DepthOfFieldFarBlurSize; // 0x624(0x04)
	float DepthOfFieldOcclusion; // 0x628(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x62c(0x04)
	float DepthOfFieldVignetteSize; // 0x630(0x04)
	float MotionBlurAmount; // 0x634(0x04)
	float MotionBlurMax; // 0x638(0x04)
	int32_t MotionBlurTargetFPS; // 0x63c(0x04)
	float MotionBlurPerObjectSize; // 0x640(0x04)
	float LPVIntensity; // 0x644(0x04)
	float LPVVplInjectionBias; // 0x648(0x04)
	float LPVSize; // 0x64c(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x650(0x04)
	float LPVSecondaryBounceIntensity; // 0x654(0x04)
	float LPVGeometryVolumeBias; // 0x658(0x04)
	float LPVEmissiveInjectionIntensity; // 0x65c(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x660(0x04)
	float LPVDirectionalOcclusionRadius; // 0x664(0x04)
	float LPVDiffuseOcclusionExponent; // 0x668(0x04)
	float LPVSpecularOcclusionExponent; // 0x66c(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x670(0x04)
	float LPVSpecularOcclusionIntensity; // 0x674(0x04)
	enum class ETranslucencyType TranslucencyType; // 0x678(0x01)
	char pad_679[0x3]; // 0x679(0x03)
	float RayTracingTranslucencyMaxRoughness; // 0x67c(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x680(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x684(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x688(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x689(0x01)
	char pad_689_1 : 7; // 0x689(0x01)
	char pad_68A[0x2]; // 0x68a(0x02)
	int32_t PathTracingMaxBounces; // 0x68c(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x690(0x04)
	float PathTracingFilterWidth; // 0x694(0x04)
	char PathTracingEnableEmissive : 1; // 0x698(0x01)
	char pad_698_1 : 7; // 0x698(0x01)
	char pad_699[0x3]; // 0x699(0x03)
	float PathTracingMaxPathExposure; // 0x69c(0x04)
	char PathTracingEnableReferenceDOF : 1; // 0x6a0(0x01)
	char PathTracingEnableDenoiser : 1; // 0x6a0(0x01)
	char pad_6A0_2 : 6; // 0x6a0(0x01)
	char pad_6A1[0x3]; // 0x6a1(0x03)
	float LPVFadeRange; // 0x6a4(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x6a8(0x04)
	float ScreenPercentage; // 0x6ac(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x6b0(0x10)
};
...
struct FBoneSocketTarget {
	...
	struct FSocketReference SocketReference; // 0x20(0x70)
};
...
struct FRepAttachment {
	...
	struct FName AttachSocket; // 0x50(0x08)
...
struct FRepMovement {
	...
	enum class EVectorQuantization LocationQuantizationLevel; // 0x61(0x01)
	enum class EVectorQuantization VelocityQuantizationLevel; // 0x62(0x01)
	enum class ERotatorQuantization RotationQuantizationLevel; // 0x63(0x01)
...
struct FAnimationGroupReference {
	...
	char pad_1[0x3]; // 0x01(0x03)
	struct FName GroupName; // 0x04(0x08)
...
struct FAnimatedBoneAttribute {
	struct FAnimationAttributeIdentifier Identifier; // 0x00(0x38)
	struct FAttributeCurve Curve; // 0x38(0xa8)
};
...
struct FAnimationAttributeIdentifier {
	...
	char pad_14[0x4]; // 0x14(0x04)
	struct UScriptStruct* ScriptStruct; // 0x18(0x08)
	struct FSoftObjectPath ScriptStructPath; // 0x20(0x18)
};
...
struct FQueuedDrawDebugItem {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FVector StartLoc; // 0x08(0x18)
	struct FVector EndLoc; // 0x20(0x18)
	struct FVector Center; // 0x38(0x18)
	struct FRotator Rotation; // 0x50(0x18)
	float Radius; // 0x68(0x04)
	float Size; // 0x6c(0x04)
	int32_t Segments; // 0x70(0x04)
	struct FColor Color; // 0x74(0x04)
	bool bPersistentLines; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	float LifeTime; // 0x7c(0x04)
	float Thickness; // 0x80(0x04)
	char pad_84[0x4]; // 0x84(0x04)
	struct FString Message; // 0x88(0x10)
	struct FVector2D TextScale; // 0x98(0x10)
	enum class ESceneDepthPriorityGroup DepthPriority; // 0xa8(0x01)
...
struct FAnimNode_Inertialization : FAnimNode_Base {
	...
	struct TArray<struct FName> FilteredCurves; // 0x20(0x10)
...
struct FAnimNode_LinkedAnimGraph : FAnimNode_CustomProperty {
	...
	char bReceiveNotifiesFromLinkedInstances : 1; // 0x94(0x01)
	char bPropagateNotifiesToLinkedInstances : 1; // 0x94(0x01)
...
struct FAnimNode_LinkedAnimLayer : FAnimNode_LinkedAnimGraph {
	struct UAnimLayerInterface* Interface; // 0x98(0x08)
	struct FName Layer; // 0xa0(0x08)
};
...
struct FAnimNode_SequencePlayer_Standalone : FAnimNode_SequencePlayerBase {
	...
	enum class EAnimGroupRole GroupRole; // 0x48(0x01)
	enum class EAnimSyncMethod Method; // 0x49(0x01)
	bool bIgnoreForRelevancyTest; // 0x4a(0x01)
...
struct FAnimNode_StateMachine : FAnimNode_Base {
	...
	bool bCreateNotifyMetaData; // 0x1a(0x01)
	bool bAllowConduitEntryStates; // 0x1b(0x01)
	char pad_1C[0x9c]; // 0x1c(0x9c)
};
...
struct FBakedStateExitTransition {
	...
	struct FName SyncGroupNameToRequireValidMarkersRule; // 0x10(0x08)
...
struct FExposedValueHandler {
	...
	struct FName BoundFunction; // 0x20(0x08)
};
...
struct FPropertyAccessLibrary {
	...
	struct TArray<struct FPropertyAccessIndirectionChain> SrcAccesses; // 0x40(0x10)
	struct TArray<struct FPropertyAccessIndirectionChain> DestAccesses; // 0x50(0x10)
	struct TArray<struct FPropertyAccessIndirection> Indirections; // 0x60(0x10)
...
struct FBaseAttenuationSettings {
	...
	char pad_11[0x7]; // 0x11(0x07)
	struct FVector AttenuationShapeExtents; // 0x18(0x18)
	float ConeOffset; // 0x30(0x04)
	float FalloffDistance; // 0x34(0x04)
	float ConeSphereRadius; // 0x38(0x04)
	float ConeSphereFalloffDistance; // 0x3c(0x04)
	struct FRuntimeFloatCurve CustomAttenuationCurve; // 0x40(0x88)
};
...
struct FSoundDebugEntry {
	struct FName DebugName; // 0x00(0x08)
...
struct FEdGraphPinType {
	...
	char bSerializeAsSinglePrecisionFloat : 1; // 0x55(0x01)
...
struct FCameraShakeUpdateParams {
	...
	struct FMinimalViewInfo POV; // 0x10(0x7a0)
};
...
struct FMinimalViewInfo {
	...
	enum class ECameraProjectionMode ProjectionMode; // 0x4c(0x01)
	char pad_4D[0x3]; // 0x4d(0x03)
	float PostProcessBlendWeight; // 0x50(0x04)
	char pad_54[0xc]; // 0x54(0x0c)
	struct FPostProcessSettings PostProcessSettings; // 0x60(0x6c0)
	struct FVector2D OffCenterProjectionOffset; // 0x720(0x10)
...
struct FRepRootMotionMontage {
	...
	struct FName MovementBaseBoneName; // 0x50(0x08)
	bool bRelativePosition; // 0x58(0x01)
	bool bRelativeRotation; // 0x59(0x01)
...
struct FFindFloorResult {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct FHitResult HitResult; // 0x10(0xe8)
};
...
struct FConstraintProfileProperties {
	...
	struct FLinearDriveConstraint LinearDrive; // 0x80(0x68)
	struct FAngularDriveConstraint AngularDrive; // 0xe8(0x68)
	char bDisableCollision : 1; // 0x150(0x01)
	char bParentDominates : 1; // 0x150(0x01)
	char bEnableLinearProjection : 1; // 0x150(0x01)
	char bEnableAngularProjection : 1; // 0x150(0x01)
	char bEnableShockPropagation : 1; // 0x150(0x01)
	char bEnableProjection : 1; // 0x150(0x01)
	char bEnableSoftProjection : 1; // 0x150(0x01)
	char bAngularBreakable : 1; // 0x150(0x01)
	char bAngularPlasticity : 1; // 0x151(0x01)
	char bLinearBreakable : 1; // 0x151(0x01)
	char bLinearPlasticity : 1; // 0x151(0x01)
	char pad_151_3 : 5; // 0x151(0x01)
	enum class EConstraintPlasticityType LinearPlasticityType; // 0x152(0x01)
...
struct FConstraintInstance : FConstraintInstanceBase {
	struct FName JointName; // 0x38(0x08)
	struct FName ConstraintBone1; // 0x40(0x08)
	struct FName ConstraintBone2; // 0x48(0x08)
	struct FVector Pos1; // 0x50(0x18)
	struct FVector PriAxis1; // 0x68(0x18)
	struct FVector SecAxis1; // 0x80(0x18)
	struct FVector Pos2; // 0x98(0x18)
	struct FVector PriAxis2; // 0xb0(0x18)
	struct FVector SecAxis2; // 0xc8(0x18)
	struct FRotator AngularRotationOffset; // 0xe0(0x18)
	char bScaleLinearLimits : 1; // 0xf8(0x01)
	char pad_F8_1 : 7; // 0xf8(0x01)
	char pad_F9[0x7]; // 0xf9(0x07)
	struct FConstraintProfileProperties ProfileInstance; // 0x100(0x158)
...
struct FTimecodeCustomAttributeNameSettings {
	struct FName HourAttributeName; // 0x00(0x08)
	struct FName MinuteAttributeName; // 0x08(0x08)
	struct FName SecondAttributeName; // 0x10(0x08)
	struct FName FrameAttributeName; // 0x18(0x08)
	struct FName SubframeAttributeName; // 0x20(0x08)
	struct FName RateAttributeName; // 0x28(0x08)
	struct FName TakenameAttributeName; // 0x30(0x08)
};
...
struct FDPMatchingIfCondition {
	struct FName Operator; // 0x00(0x08)
...
struct FWorldContext {
	...
	struct FURL LastURL; // 0xc0(0x68)
	struct FURL LastRemoteURL; // 0x128(0x68)
	struct UPendingNetGame* PendingNetGame; // 0x190(0x08)
	struct TArray<struct FFullyLoadedPackagesInfo> PackagesToFullyLoad; // 0x198(0x10)
	char pad_1A8[0x10]; // 0x1a8(0x10)
	struct TArray<struct ULevel*> LoadedLevelsForPendingMapChange; // 0x1b8(0x10)
	char pad_1C8[0x18]; // 0x1c8(0x18)
	struct TArray<struct UObjectReferencer*> ObjectReferencers; // 0x1e0(0x10)
	struct TArray<struct FLevelStreamingStatus> PendingLevelStreamingStatusUpdates; // 0x1f0(0x10)
	struct UGameViewportClient* GameViewport; // 0x200(0x08)
	struct UGameInstance* OwningGameInstance; // 0x208(0x08)
	struct TArray<struct FNamedNetDriver> ActiveNetDrivers; // 0x210(0x10)
...
struct FStrataMaterialInfo {
	char ShadingModelField; // 0x00(0x01)
	char bHasShadingModelFromExpression; // 0x01(0x01)
	char pad_2[0x6]; // 0x02(0x06)
...
struct FPointDamageEvent : FDamageEvent {
	...
	struct FHitResult HitInfo; // 0x30(0xe8)
};
...
struct FPredictProjectilePathResult {
	...
	struct FHitResult HitResult; // 0x48(0xe8)
};
...
struct FCameraPreviewInfo {
	...
	struct FRotator Rotation; // 0x28(0x18)
	struct APawn* PawnInst; // 0x40(0x08)
};
...
struct FLevelSimplificationDetails {
	...
	bool bGenerateMeshNormalMap; // 0x13a(0x01)
	bool bGenerateMeshMetallicMap; // 0x13b(0x01)
	bool bGenerateMeshRoughnessMap; // 0x13c(0x01)
	bool bGenerateMeshSpecularMap; // 0x13d(0x01)
	bool bGenerateLandscapeNormalMap; // 0x13e(0x01)
	bool bGenerateLandscapeMetallicMap; // 0x13f(0x01)
	bool bGenerateLandscapeRoughnessMap; // 0x140(0x01)
	bool bGenerateLandscapeSpecularMap; // 0x141(0x01)
...
struct FNewLevelInstanceParams {
	...
	struct UWorld* TemplateWorld; // 0x10(0x08)
	struct FString LevelPackageName; // 0x18(0x10)
	bool bPromptForSave; // 0x28(0x01)
	bool bExternalActors; // 0x29(0x01)
	bool bForceExternalActors; // 0x2a(0x01)
	bool bHideCreationType; // 0x2b(0x01)
	char pad_2C[0x4]; // 0x2c(0x04)
};
...
struct FMaterialCachedParameterEditorInfo {
	...
	int32_t SortPriority; // 0x18(0x04)
...
struct FMaterialCachedParameters {
	...
	struct TArray<struct UTexture*> TextureValues; // 0x230(0x10)
	struct TArray<struct UFont*> FontValues; // 0x240(0x10)
	struct TArray<int32_t> FontPageValues; // 0x250(0x10)
	struct TArray<struct URuntimeVirtualTexture*> RuntimeVirtualTextureValues; // 0x260(0x10)
};

// ScriptStruct Engine.MaterialCachedExpressionData
// Size: 0x2f8 (Inherited: 0x00)
struct FMaterialCachedExpressionData {
	struct FMaterialCachedParameters Parameters; // 0x00(0x270)
	...
	struct FMaterialLayersFunctions MaterialLayers; // 0x2a0(0x20)
	struct TArray<struct ULandscapeGrassType*> GrassTypes; // 0x2c0(0x10)
	...
	uint32_t MaterialAttributesPropertyConnectedBitmask; // 0x2f4(0x04)
};
...
struct FCustomInput {
	...
	struct FExpressionInput Input; // 0x08(0x14)
};
...
struct FMeshMergingSettings {
	...
	int32_t SpecificLOD; // 0xa4(0x04)
	enum class EMeshLODSelectionType LODSelectionType; // 0xa8(0x01)
	char bGenerateLightMapUV : 1; // 0xa9(0x01)
	char bComputedLightMapResolution : 1; // 0xa9(0x01)
	char bPivotPointAtZero : 1; // 0xa9(0x01)
	char bMergePhysicsData : 1; // 0xa9(0x01)
	char bMergeMaterials : 1; // 0xa9(0x01)
	char bCreateMergedMaterial : 1; // 0xa9(0x01)
	char bBakeVertexDataToMesh : 1; // 0xa9(0x01)
	char bUseVertexDataForBakingMaterial : 1; // 0xa9(0x01)
	char bUseTextureBinning : 1; // 0xaa(0x01)
	char bReuseMeshLightmapUVs : 1; // 0xaa(0x01)
	char bMergeEquivalentMaterials : 1; // 0xaa(0x01)
	char bUseLandscapeCulling : 1; // 0xaa(0x01)
	char bIncludeImposters : 1; // 0xaa(0x01)
	char bAllowDistanceField : 1; // 0xaa(0x01)
	char bGenerateNaniteEnabledMesh : 1; // 0xaa(0x01)
	char pad_AA_7 : 1; // 0xaa(0x01)
	char pad_AB[0x1]; // 0xab(0x01)
	float NaniteFallbackTrianglePercent; // 0xac(0x04)
...
struct FMirrorTableRow : FTableRowBase {
	...
	struct FName MirroredName; // 0x10(0x08)
	enum class EMirrorRowType MirrorEntryType; // 0x18(0x01)
	char pad_19[0x7]; // 0x19(0x07)
};
...
struct FMirrorFindReplaceExpression {
	struct FName FindExpression; // 0x00(0x08)
	struct FName ReplaceExpression; // 0x08(0x08)
	enum class EMirrorFindReplaceMethod FindReplaceMethod; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
};
...
struct FTrajectorySample {
	...
	struct FVector position; // 0x08(0x18)
	struct FVector LocalLinearVelocity; // 0x20(0x18)
	struct FVector LocalLinearAcceleration; // 0x38(0x18)
};
...
struct FNavDataConfig : FNavAgentProperties {
	...
	char pad_3C[0x4]; // 0x3c(0x04)
	struct FVector DefaultQueryExtent; // 0x40(0x18)
	struct AActor* NavigationDataClass; // 0x58(0x08)
	struct TSoftClassPtr<UObject> NavDataClass; // 0x60(0x28)
};
...
struct FChannelDefinition {
	...
	ClassPtrProperty ChannelClass; // 0x10(0x08)
...
struct FPhysicsConstraintProfileHandle {
	struct FConstraintProfileProperties ProfileProperties; // 0x00(0x158)
	struct FName ProfileName; // 0x158(0x08)
};
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x7a0)
	struct APlayerState* PlayerState; // 0x7b0(0x08)
...
struct FUpdateLevelStreamingLevelStatus {
	...
	bool bNewShouldBeLoaded; // 0x0c(0x01)
	bool bNewShouldBeVisible; // 0x0d(0x01)
	bool bNewShouldBlockOnLoad; // 0x0e(0x01)
	char pad_F[0x1]; // 0x0f(0x01)
};
...
struct FRPCAnalyticsThreshold {
	struct FName RPC; // 0x00(0x08)
	int32_t CountPerSec; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
...
struct FSoundAttenuationSettings : FBaseAttenuationSettings {
	...
	char bEnablePriorityAttenuation : 1; // 0xc9(0x01)
	char bApplyNormalizationToStereoSounds : 1; // 0xc9(0x01)
	char bEnableLogFrequencyScaling : 1; // 0xc9(0x01)
	char bEnableSubmixSends : 1; // 0xc9(0x01)
	char bEnableSourceDataOverride : 1; // 0xc9(0x01)
	char pad_C9_5 : 3; // 0xc9(0x01)
	...
	enum class EPriorityAttenuationMethod PriorityAttenuationMethod; // 0xd3(0x01)
	float OmniRadius; // 0xd4(0x04)
	float StereoSpread; // 0xd8(0x04)
	float LPFRadiusMin; // 0xdc(0x04)
	float LPFRadiusMax; // 0xe0(0x04)
	char pad_E4[0x4]; // 0xe4(0x04)
	struct FRuntimeFloatCurve CustomLowpassAirAbsorptionCurve; // 0xe8(0x88)
	struct FRuntimeFloatCurve CustomHighpassAirAbsorptionCurve; // 0x170(0x88)
	float LPFFrequencyAtMin; // 0x1f8(0x04)
	float LPFFrequencyAtMax; // 0x1fc(0x04)
	float HPFFrequencyAtMin; // 0x200(0x04)
	float HPFFrequencyAtMax; // 0x204(0x04)
	float FocusAzimuth; // 0x208(0x04)
	float NonFocusAzimuth; // 0x20c(0x04)
	float FocusDistanceScale; // 0x210(0x04)
	float NonFocusDistanceScale; // 0x214(0x04)
	float FocusPriorityScale; // 0x218(0x04)
	float NonFocusPriorityScale; // 0x21c(0x04)
	float FocusVolumeAttenuation; // 0x220(0x04)
	float NonFocusVolumeAttenuation; // 0x224(0x04)
	float FocusAttackInterpSpeed; // 0x228(0x04)
	float FocusReleaseInterpSpeed; // 0x22c(0x04)
	float OcclusionLowPassFilterFrequency; // 0x230(0x04)
	float OcclusionVolumeAttenuation; // 0x234(0x04)
	float OcclusionInterpolationTime; // 0x238(0x04)
	float ReverbWetLevelMin; // 0x23c(0x04)
	float ReverbWetLevelMax; // 0x240(0x04)
	float ReverbDistanceMin; // 0x244(0x04)
	float ReverbDistanceMax; // 0x248(0x04)
	float ManualReverbSendLevel; // 0x24c(0x04)
	struct FRuntimeFloatCurve CustomReverbSendCurve; // 0x250(0x88)
	struct TArray<struct FAttenuationSubmixSendSettings> SubmixSendSettings; // 0x2d8(0x10)
	float PriorityAttenuationMin; // 0x2e8(0x04)
	float PriorityAttenuationMax; // 0x2ec(0x04)
	float PriorityAttenuationDistanceMin; // 0x2f0(0x04)
	float PriorityAttenuationDistanceMax; // 0x2f4(0x04)
	float ManualPriorityAttenuation; // 0x2f8(0x04)
...
struct FStaticTerrainLayerWeightParameter {
	...
	int32_t WeightmapIndex; // 0x08(0x04)
	bool bWeightBasedBlend; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
};
...
struct FStaticMaterialLayersParameter : FStaticParameterBase {
	char pad_24[0x4]; // 0x24(0x04)
	struct FMaterialLayersFunctions Value; // 0x28(0x20)
};
...
struct FStaticParameterSet {
	...
	struct FMaterialLayersFunctions MaterialLayers; // 0x30(0x20)
	char bHasMaterialLayers : 1; // 0x50(0x01)
...
struct FTextureLODGroup {
	...
	struct FName MinMagFilter; // 0x3c(0x08)
	struct FName MipFilter; // 0x44(0x08)
	enum class ETextureMipLoadOptions MipLoadOptions; // 0x4c(0x01)
	bool HighPriorityLoad; // 0x4d(0x01)
	bool DuplicateNonOptionalMips; // 0x4e(0x01)
	char pad_4F[0x1]; // 0x4f(0x01)
	float Downscale; // 0x50(0x04)
	enum class ETextureDownscaleOptions DownscaleOptions; // 0x54(0x01)
	char pad_55[0x3]; // 0x55(0x03)
	int32_t VirtualTextureTileCountBias; // 0x58(0x04)
	int32_t VirtualTextureTileSizeBias; // 0x5c(0x04)
	enum class ETextureLossyCompressionAmount LossyCompressionAmount; // 0x60(0x01)
	char pad_61[0x3]; // 0x61(0x03)
};
...
struct FSpatialHashStreamingGridLevel {
	...
	struct TMap<int32_t, int32_t> LayerCellsMapping; // 0x10(0x50)
};

// ScriptStruct Engine.SpatialHashStreamingGrid
// Size: 0xa8 (Inherited: 0x00)
struct FSpatialHashStreamingGrid {
	struct FName GridName; // 0x00(0x08)
...
struct FHierarchicalSimplification {
	...
	struct FMeshMergingSettings MergeSetting; // 0xc4(0xb4)
	float DesiredBoundRadius; // 0x178(0x04)
	float DesiredFillingPercentage; // 0x17c(0x04)
	int32_t MinNumberOfActorsToBuild; // 0x180(0x04)
};
